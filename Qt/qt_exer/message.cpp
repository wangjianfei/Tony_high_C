...
/*注释*/
    ...
    QString filename = QString::fromUtf8("/home/akaedu/broad/ad_machine/system_picture/tomandjerry.jpg");
   ...
   // label_message->setText(msg);/*注释*/
   // label_message->setGeometry(i, 410,800,70);/*注释*/
