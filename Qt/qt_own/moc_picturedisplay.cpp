...
**
** Created: Tue Nov 8 11:38:45 2011
...
static const char qt_meta_stringdata_myPicture[] = {
    "myPicture\0\0show_picture()\0"
};

const QMetaObject myPicture::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_myPicture,
      qt_meta_data_myPicture, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &myPicture::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myPicture))
        return static_cast<void*>(const_cast< myPicture*>(this));
